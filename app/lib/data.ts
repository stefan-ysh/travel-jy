...
export const restaurants: Restaurant[] = [
  ...
  },
  {
    ...
    image: "/images/attractions/安东老街.png",
    location: {
      lat: 40.104901,
      lng: 124.36,
    },
...
export const routes: Route = {
  ...
  schedule: [
    ...
    },
    {
      ...
      image: "/images/attractions/kmyc-museum.png",
    ...
    },
    {
      ...
      image: "/images/food/高社长长白山中韩料理.png",
      priceRange: "¥60-100/人",
    ...
    },
    {
      ...
      image: "/images/attractions/鸭绿江断桥.png",
      photoSpots: [
        "断桥观景台",
        "断桥断裂处",
        "朝鲜太阳楼视角",
    ...
    },
    {
      ...
      activity: "与亲友聚餐",
      location: "当地餐厅",
      description: "与小妹儿母亲共进晚餐，品尝当地美食，享受温馨的聚会时光。",
      tips: "丹东的特色美食有朝鲜冷面、海鲜、烤肉等，可以请当地人推荐正宗的餐馆。",
      transportation: "出租车或步行",
      image: "/images/亲友相聚.png",
    ...
    },
    {
      ...
      image: "/images/attractions/虎山长城.png",
      mustSee: ["山顶观景台", "长城古迹"],
    },
    {
      ...
      image: "/images/attractions/锦江山公园.png",
    ...
    },
    {
      ...
      activity: "自由活动",
      location: "随机",
      description: "注意车辆安全，交通比较混乱",
      tips: "购物休闲喝咖啡等",
      transportation: "",
      image: "/images/自由活动.png",
      // priceRange: "",
      // recommendations: [],
    },
    {
    ...
    },
    {
      ...
      transportation: "步行",
      image: "/images/attractions/江边.png",
...
// Check-in spot data
export const checkInSpots = [
  {
    id: 1,
    title: '"丹东"大字墙打卡',
    description:
      "导航【赫氏燕窝】路边转角很好找，很出片，傍晚18:00去的，阳光已经没有了，建议白天去",
    ratings: {
      photo: 5,
      difficulty: 2,
      transportation: 5,
    ...
    tips: "建议白天前往，光线更好",
    images: [
      "/images/checkin/dandong-big-label/1.png",
      "/images/checkin/dandong-big-label/2.png",
      "/images/checkin/dandong-big-label/3.png",
      "/images/checkin/dandong-big-label/4.png",
      "/images/checkin/dandong-big-label/5.png",
      "/images/checkin/dandong-big-label/6.png",
      "/images/checkin/dandong-big-label/7.png",
    ],
    location: "丹东市振兴区滨江中路附近赫氏燕窝门口",
    categories: ["打卡", "拍照"],
  },
  {
    id: 2,
    title: "Hi Jojo Coffee",
    description:
      "坐落在鸭绿江畔的咖啡厅，适合从滨江中路步行前往，隔壁还有文化体验馆，可以租朝鲜服，临近老安东阁，经常人满为患，可以早点去，点杯咖啡看江景绝了！",
    ratings: {
      photo: 5,
      difficulty: 3,
      transportation: 4,
    ...
    tips: "建议早点去，避开人流高峰期",
    images: [
      "/images/checkin/hijojo/1.png",
      "/images/checkin/hijojo/2.png",
      "/images/checkin/hijojo/3.png",
      "/images/checkin/hijojo/4.png",
      "/images/checkin/hijojo/5.png",
      "/images/checkin/hijojo/6.png",
      "/images/checkin/hijojo/7.png",
      "/images/checkin/hijojo/8.png",
      "/images/checkin/hijojo/9.png",
      "/images/checkin/hijojo/10.png",
      "/images/checkin/hijojo/11.png",
    ],
    location: "鸭绿江畔滨江中路段",
    categories: ["咖啡", "文艺", "拍照"],
  },
  {
    ...
    title: "鸭绿江断桥",
    description:
      "鸭绿江断桥可以看到对岸朝鲜的建筑，像江上的落日。这里人超多，五一假期只能和大家排队在江边扶栏拍点照纪念一下。这里有两座桥，一座是抗美援朝战争被炸断的，当今修复用来参观，还有一座是后建用来中朝贸易往来。",
    ratings: {
      photo: 4,
      difficulty: 4,
      transportation: 3,
    ...
    tips: "人流量大，交通可能拥堵",
    images: [
      "/images/checkin/broken-bridge/1.png",
      "/images/checkin/broken-bridge/2.png",
      "/images/checkin/broken-bridge/3.png",
      "/images/checkin/broken-bridge/4.png",
    ],
  ...
  },
  {
    ...
    title: "安东老街",
    description:
      "安东老街是丹东市的一个历史文化街区，有着悠久的历史和丰富的文化底蕴。这里有许多传统的建筑和街道，可以感受到丹东的历史和文化。",
    ratings: {
      photo: 4,
      difficulty: 3,
      transportation: 4,
    ...
    price: "免费",
    isFree: true,
    tips: "其实是一个建筑的一楼，其特色在二楼，小吃的话，一楼的焖子强推。",
    images: [
      "/images/checkin/andong-old-street/1.png",
      "/images/checkin/andong-old-street/2.png",
      "/images/checkin/andong-old-street/3.png",
      "/images/checkin/andong-old-street/4.png",
      "/images/checkin/andong-old-street/5.png",
      "/images/checkin/andong-old-street/6.png",
      "/images/checkin/andong-old-street/7.png",
    ],
    location: "丹东市振兴区安东老街",
    categories: ["景点", "历史", "拍照", "美食"],
  },
  {
    id: 5,
    title: "丹东国门",
    description:
      "丹东国门是中朝边境最大的国门，这里人超多，假期只能和大家排队在江边扶栏拍点照纪念一下。",
    ratings: {
      photo: 4,
      difficulty: 3,
      transportation: 4,
    ...
    price: "免费",
    isFree: true,
    tips: "时间充足前提下前往，往返车程 3 小时左右，国门拍照📷不用上二楼，在国门下面拍照最出片。",
    images: ["/images/checkin/guomen/1.png", "/images/checkin/guomen/2.png"],
